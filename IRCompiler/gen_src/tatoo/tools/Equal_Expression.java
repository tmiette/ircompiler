...
public class Equal_Expression extends FlatNode<Node,Node,NoValue> implements Serializable, IExpression {
  Equal_Expression() {
    // used by XML serialization
  }
  public Equal_Expression(IExpression expression, IExpression expression2) {
  ...
  private static final long serialVersionUID=204969272481728850L;
}
