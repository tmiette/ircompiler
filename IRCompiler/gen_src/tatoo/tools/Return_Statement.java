...
public class Return_Statement extends FlatNode<IExpression,Node,NoValue> implements Serializable, IStatement {
  Return_Statement() {
    // used by XML serialization
  }
  public Return_Statement(IExpression expression) {
  ...
  private static final long serialVersionUID=9006487969618349169L;
}
