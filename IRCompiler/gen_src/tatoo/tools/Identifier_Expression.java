...
public class Identifier_Expression extends FlatNode<Node,Node,String> implements Serializable, IExpression {
  Identifier_Expression() {
    // used by XML serialization
  }
  public Identifier_Expression(String identifier_) {
  ...
  private static final long serialVersionUID=-1391221620671806952L;
}
