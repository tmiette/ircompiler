...
public class Pow_Expression extends FlatNode<Node,Node,NoValue> implements Serializable, IExpression {
  Pow_Expression() {
    // used by XML serialization
  }
  public Pow_Expression(IExpression expression, IExpression expression2) {
  ...
  private static final long serialVersionUID=505075947270911990L;
}
