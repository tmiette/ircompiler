...
public class Div_Expression extends FlatNode<Node,Node,NoValue> implements Serializable, IExpression {
  Div_Expression() {
    // used by XML serialization
  }
  public Div_Expression(IExpression expression, IExpression expression2) {
  ...
  private static final long serialVersionUID=-4711090005640702700L;
}
