...
public class Inequal_Expression extends FlatNode<Node,Node,NoValue> implements Serializable, IExpression {
  Inequal_Expression() {
    // used by XML serialization
  }
  public Inequal_Expression(IExpression expression, IExpression expression2) {
  ...
  private static final long serialVersionUID=840102491168176064L;
}
