...
public class Par_Expression extends FlatNode<IExpression,Node,NoValue> implements Serializable, IExpression {
  Par_Expression() {
    // used by XML serialization
  }
  public Par_Expression(IExpression expression) {
  ...
  private static final long serialVersionUID=-8694103595526621080L;
}
