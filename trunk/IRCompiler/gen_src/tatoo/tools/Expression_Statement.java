...
public class Expression_Statement extends FlatNode<IExpression,Node,NoValue> implements Serializable, IStatement {
  Expression_Statement() {
    // used by XML serialization
  }
  public Expression_Statement(IExpression expression) {
  ...
  private static final long serialVersionUID=-8846742627459080000L;
}
