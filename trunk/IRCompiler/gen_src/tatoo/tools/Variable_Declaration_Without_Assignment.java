...
public class Variable_Declaration_Without_Assignment extends FlatNode<IType,Node,String> implements Serializable, IVariable_Declaration {
  Variable_Declaration_Without_Assignment() {
    // used by XML serialization
  }
  public Variable_Declaration_Without_Assignment(IType type, String identifier_) {
    setType(type);
  ...
  public String getName() {
    return "variable-declaration-without-assignment";
  }
  ...
  private static final long serialVersionUID=-7202211156333159214L;
}
