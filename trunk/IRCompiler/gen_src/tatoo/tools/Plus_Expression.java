...
public class Plus_Expression extends FlatNode<Node,Node,NoValue> implements Serializable, IExpression {
  Plus_Expression() {
    // used by XML serialization
  }
  public Plus_Expression(IExpression expression, IExpression expression2) {
  ...
  private static final long serialVersionUID=8261046913516089838L;
}
